        ...
        InlineKeyboardMarkup size = new(new[]
{
        ...
        {
            case "base_menuM":
                await client.SendPhotoAsync(update.CallbackQuery.From.Id, InputFile.FromUri("https://raw.githubusercontent.com/r0zmarin1/TGbot/master/TGbot/pictures/base_menu1.jpg"), caption: "супер! что дальше?", replyMarkup: base_menuM, cancellationToken: token);
                break;
            case "special_menuM":
                await client.SendPhotoAsync(update.CallbackQuery.From.Id, InputFile.FromUri("https://raw.githubusercontent.com/r0zmarin1/TGbot/master/TGbot/pictures/special1.png"), caption: "супер! что дальше?", replyMarkup: special_menuM, cancellationToken: token);
                break;
            case "base_menuS":
                await client.SendPhotoAsync(update.CallbackQuery.From.Id, InputFile.FromUri("https://raw.githubusercontent.com/r0zmarin1/TGbot/master/TGbot/pictures/base_menu1.jpg"), caption: "супер! что дальше?", replyMarkup: base_menuS, cancellationToken: token);
                break;
            case "special_menuS":
                await client.SendPhotoAsync(update.CallbackQuery.From.Id, InputFile.FromUri("https://raw.githubusercontent.com/r0zmarin1/TGbot/master/TGbot/pictures/special1.png"), caption: "супер! что дальше?", replyMarkup: special_menuS, cancellationToken: token);
                break;
        }
        ...
        {
            case "adds":
                await client.SendPhotoAsync(update.CallbackQuery.From.Id, InputFile.FromUri("https://raw.githubusercontent.com/r0zmarin1/TGbot/master/TGbot/pictures/adds1.png"), caption: "супер! что дальше?", replyMarkup: adds, cancellationToken: token);
                break;
        ...
        {
            case "max":
                await client.SendPhotoAsync(update.CallbackQuery.From.Id, InputFile.FromUri("https://raw.githubusercontent.com/r0zmarin1/TGbot/master/TGbot/pictures/menu1.jpeg"), caption: "глянь меню и выбери категорию", replyMarkup: newOrderM, cancellationToken: token);
                break;
            case "small":
                await client.SendPhotoAsync(update.CallbackQuery.From.Id, InputFile.FromUri("https://raw.githubusercontent.com/r0zmarin1/TGbot/master/TGbot/pictures/menu1.jpeg"), caption: "глянь меню и выбери категорию", replyMarkup: newOrderS, cancellationToken: token);
                break;
        }
        ...
        {
            case "/start":
                await client.SendPhotoAsync(update.Message.Chat.Id, InputFile.FromUri("https://raw.githubusercontent.com/r0zmarin1/TGbot/master/TGbot/pictures/greeting_photo1.jpeg"), caption: "На связи Кисса-бот!\nВыбери нужную команду;)", replyMarkup: replyKeyboardMarkup, cancellationToken: token);
            ...
            case "меню":
                await client.SendPhotoAsync(update.Message.Chat.Id, InputFile.FromUri("https://raw.githubusercontent.com/r0zmarin1/TGbot/master/TGbot/pictures/menu1.jpeg"), replyMarkup: replyKeyboardMarkup, cancellationToken: token);
                update.Message.Text = null;
                break;
